...
def escribir_preguntas(lista_preguntas: list, path: str):
    ...
    resultado = escribir_datos_formateados_a_csv(path, lista_preguntas, formatear_pregunta_csv, encabezado)
    return resultado

def cargar_preguntas(path: str) -> list:
    pregunta = leer_datos_csv(path, leer_linea_pregunta)
    return pregunta
...
def escribir_estadisticas(lista_estadisticas: list, path: str):
    ...
    resultado = escribir_datos_formateados_a_csv(path, lista_estadisticas, formatear_estadistica_csv, encabezado)
    return resultado

def leer_estadisticas(path: str) -> list:
    estadistica = leer_datos_csv(path, leer_linea_estadisticas)
    return estadistica